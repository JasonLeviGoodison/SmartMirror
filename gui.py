''' 
    DISCLAIMER: I DID NOT WRITE MOST OF THE FOLLOWING CODE. ASSETS AND UI CODE ARE FROM FOLLOWING
    ORIGINAL: https://github.com/HackerShackOfficial/Smart-Mirror/blob/master/
    I MODIFIED THE CODE FROM ABOVE FOR MY OWN PURPOSES
'''
...
class Weather(Frame):
    ...
    def get_weather(self):
        try:
            weather_obj = WeatherIntent.getWeather();
            print weather_obj
            degree_sign= u'\N{DEGREE SIGN}'
            temperature2 = str(int(float(weather_obj['temp']))) + degree_sign
            currently2 = weather_obj['weather']
            forecast2 = weather_obj["summary"]

            icon_id = weather_obj['icon']
            icon2 = None
